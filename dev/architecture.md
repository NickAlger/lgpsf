...
| `init_dictionary.hpp` | Initial-ellipsoid hypothesis generation: geometry and policy, no probes and no fitting. First place `ellipsoid_tree`'s layout flip bites — its KDTree wants points as columns. |
