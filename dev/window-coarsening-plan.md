...
**S7 — the user-facing note. DONE 2026-09-07** (`docs/window-coarsening-notes.pdf`, 6 pages). Original brief: `docs/window-coarsening-notes.tex` / `.pdf`,
...
**S8 — a narrated example. DONE 2026-09-07** (`examples/coarsened_fit.py`, page `docs/examples/coarsened_fit.md`: 31,005-point window, eps 0.1 -> 5,885 cells, 5.5x faster, axes/angle/c within ~1%; the coarse score reads pessimistic on this target, the full-window re-score within 2.3%). Original brief: `examples/coarsened_fit.py` (a page generated by
