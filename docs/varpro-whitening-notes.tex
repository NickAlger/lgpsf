...
in \texttt{lg\_harmonics\_table.hpp} and \texttt{lg\_functions.hpp}), the
...
implementing it, and confirmed numerically (\texttt{test\_whitening.cpp}) by
...
for Stage~1/Stage~2 composition in \texttt{ellipsoid\_transform.hpp} and for
the extra-basis projection in the 2026-07-23 design discussion. No new
derivative formulas are needed anywhere; \texttt{lg\_functions.hpp} and
\texttt{ellipsoid\_transform.hpp} are unchanged.
