...
*Generated by `docs/generate_examples.py` from [`examples/operator_diagnostics.py`](../../examples/operator_diagnostics.py); the output and figures above come from actually running it.*
